...
# Core and utilities
sudo pacman -S --noconfirm --needed acpi alsa-plugins android-tools android-file-transfer aspell
...
sudo pacman -S --noconfirm --needed imagemagick inotify-tools
sudo pacman -S --noconfirm --needed jdk-openjdk julia
# sudo pacman -S --noconfirm --needed k
sudo pacman -S --noconfirm --needed lazygit less libreoffice-fresh loupe luarocks lutris
...
sudo pacman -S --noconfirm --needed qt5 qt6 quickshell
...
sudo pacman -S --noconfirm --needed zathura zathura-pdf-mupdf zig zip zoxide
